...
export class LibConfig {
  ...
  static readonly COPYRIGHT_AUTHOR = MultiKeywordsHighlighterConstants.COPYRIGHT.AUTHOR;
  static readonly COPYRIGHT_CONTACT = MultiKeywordsHighlighterConstants.COPYRIGHT.CONTACT;
}
